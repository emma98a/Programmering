...
//Match registered user to user in storage
...
router.put("/create", (req, res) => {
  ...
  for (let i = 0; i < userArray.length; i++) {
    if (userArray[i].id == req.body.id) {
      //i'et fortæller bare for loop at den skal køre igennem 1, så 2 , så 3 and so on
...
router.delete("/create/:id", (req, res) => {
  //når man sætter en kolon foran et eller andet, bliver det til en parameter, som vi så ender med at skrive i req.params
